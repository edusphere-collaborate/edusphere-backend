...
export class AuthService {
  ...
  async verifyResetToken(rawToken: string) {
    const tokenHash = /* reuse tokenService.hash logic indirectly by trying to find */ null;
    ...
    return { success: true, valid: true, expiresAt: token.expiresAt.toISOString(), email: masked };
  }
}
